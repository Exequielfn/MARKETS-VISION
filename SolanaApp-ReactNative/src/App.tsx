        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3 sm:py-4">
          <div className="flex flex-col sm:flex-row items-center justify-between">
            <div className="flex items-center gap-2 sm:gap-3 mb-2 sm:mb-0">
              <img src={WzrdLogo} alt="MarketWizard" className="h-10 sm:h-12 w-auto" />
              <div>
      ...
      <main className="max-w-7xl mx-auto px-6 py-8 space-y-8">
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
            Leverage advanced AI analysis powered by Gemini to get informed
            market insights. Connect your wallet to track your analysis history.
          </p>
        </div>
        ...
        <footer className="text-center py-8 text-gray-500 dark:text-gray-400">
          <p className="text-sm">
            Built for Solana • Powered by AI • Alpha Vantage Data
          </p>
