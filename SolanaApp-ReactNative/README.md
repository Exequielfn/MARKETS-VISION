# MarketWizard - AI Stock & Crypto Analysis Platform

AI-Powered market analysis application for stocks and cryptocurrencies, built on Solana network with Google Gemini AI and Alpha Vantage data.

## Features

- 🤖 **AI Analysis**: Advanced market analysis using Google Gemini AI
